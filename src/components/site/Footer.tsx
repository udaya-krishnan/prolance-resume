...
const footerServices = [
  ...
  { label: "LinkedIn Optimisation", to: "/linkedin-optimisation" },
  { label: "Cover Letter Writing", to: "/services" },
  { label: "SOP Writing", to: "/services" },
  { label: "International Resume", to: "/services" },
  { label: "Resume Templates", to: "/resume-templates" },
];

const footerLocations = [
  { label: "Resume Writing in Kerala", to: "/resume-writing-kerala" },
  { label: "Resume Writing in Kochi", to: "/resume-writing-kochi" },
  { label: "Resume Writing in Bangalore", to: "/resume-writing-bangalore" },
  { label: "Resume Writing in Dubai UAE", to: "/resume-writing-dubai-uae" },
  { label: "Resume Writing in Qatar", to: "/resume-writing-qatar" },
...
export function Footer() {  
  return (
    <footer className="relative mt-24 overflow-hidden bg-[color:var(--brand-ink)] text-white">
      ...
      {/* Main grid */}
      <div className="relative mx-auto grid max-w-7xl gap-10 px-6 py-16 md:grid-cols-2 lg:grid-cols-5">
  ...
  <span className="font-display text-lg font-bold tracking-tight">
    Prolance <span className="text-gradient-brand">Resume</span>
          ...
          <p className="mt-4 text-sm leading-relaxed text-white/70">
            India's leading ATS resume writing service. Human-crafted, ATS-optimised resumes, LinkedIn profiles,
            cover letters, and SOPs — built for professionals targeting India, Gulf, UK, Canada, Australia, and Europe.
          </p>
          <p className="mt-3 text-xs text-white/50">
            ATS-Optimized · Human-Crafted · 10,000+ Resumes Delivered
          </p>
          ...
          <div className="mt-5 flex gap-3">
            ...
            <a
              ...
              rel="noopener noreferrer"
              aria-label="WhatsApp"
              className="grid h-9 w-9 place-items-center rounded-full bg-[#25D366]/20 transition hover:bg-[#25D366]/40"
            >
              <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
        ...
        {/* Services column */}
        <div>
          <h4 className="text-sm font-semibold uppercase tracking-wider text-white/50">Services</h4>
          <ul className="mt-4 space-y-2.5 text-sm text-white/75">
            {footerServices.map((s) => (
              <li key={s.label}>
                <Link to={s.to} className="transition hover:text-white">
                  {s.label}
                </Link>
              </li>
            ))}
        ...
        {/* Local SEO locations */}
        <div>
          <h4 className="text-sm font-semibold uppercase tracking-wider text-white/50">Locations</h4>
          <ul className="mt-4 space-y-2.5 text-sm text-white/75">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3.5 text-sm text-white/75">
            <li>
              ...
              >
                <svg className="mt-0.5 h-4 w-4 shrink-0 text-[#25D366]" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/>
                </svg>
                +91 6360817439
              </a>
            ...
            <li>
              <a
                href="mailto:contact@prolanceresume.com"
                className="flex items-start gap-2 transition hover:text-white"
              >
          ...
          <div className="mt-6 space-y-1.5 text-xs text-white/50">
            <div>✓ ATS Score 80+ Guaranteed</div>
            <div>✓ Same-Day Delivery Available</div>
            <div>✓ 30 Days Editing Support</div>
            <div>✓ Accepted in 30+ Countries</div>
          </div>
        </div>
      </div>
      ...
      <div className="relative border-t border-white/10">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-3 px-6 py-6 text-xs text-white/50 md:flex-row">
          ...
          <p className="text-center">
            ATS-Optimized · Human-Crafted · Trusted by 10,000+ professionals across 30+ countries.
          </p>
