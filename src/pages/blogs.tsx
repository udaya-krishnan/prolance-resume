          ...
          {posts.map((p) => (
            ...
            >
              ...
              <div className="relative h-48 w-full overflow-hidden bg-slate-100">
                ...
                <span className="absolute left-4 top-4 rounded-full bg-white/95 px-3 py-1 text-[11px] font-bold uppercase tracking-wider text-[color:var(--brand-deep)] shadow-sm backdrop-blur">
                  {p.category}
                </span>
              </div>
              ...
              <div className="flex flex-1 flex-col p-6">
                <h3 className="font-display text-lg font-semibold transition group-hover:text-[color:var(--brand)]">
                  {p.title}
                </h3>
