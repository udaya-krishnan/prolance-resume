...
const included = [
  {
    icon: PenLine,
    title: "Keyword-optimised headline rewrite",
    desc: "A headline built around the exact terms recruiters search for in your role and industry.",
  },
  {
    icon: Sparkle,
    title: "Compelling About / Summary section",
    desc: "A narrative that positions your experience, strengths, and career direction, not a resume copy-paste.",
  },
  {
    icon: ListChecks,
    title: "Experience section rewrites",
    desc: "Achievement-led rewrites of every role, aligned with your resume and optimised for recruiter search.",
  },
  {
    icon: CheckCircle2,
    title: "Skills section: top 50 for your role",
    desc: "The 50 skills most likely to surface your profile in recruiter searches for your target roles.",
  },
  {
    icon: Image,
    title: "Custom banner design",
    desc: "A professional banner image tailored to your industry and personal brand.",
  },
  {
    icon: Search,
    title: "Profile SEO keyword audit",
    desc: "A full audit of your existing profile against the keywords recruiters in your field actually search.",
  },
  {
    icon: Users,
    title: "Recommendations strategy",
    desc: "Guidance on who to ask, and what to ask for, to build credible, relevant recommendations.",
  },
  {
    icon: Eye,
    title: "Open-to-work visibility settings guide",
    desc: "How to configure visibility so the right recruiters see you, without alerting your current employer.",
  },
  {
    icon: MessageCircle,
    title: "WhatsApp support & revisions",
    desc: "Direct access to your writer for revisions until the profile feels right.",
  },
];
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-6 pb-16 pt-16 lg:grid-cols-2 lg:pt-24">
          <div className="reveal">
            ...
            <h1 className="mt-6 font-display text-4xl font-bold leading-[1.05] sm:text-5xl lg:text-6xl">
              A Profile That Gets{" "}
              <span className="text-gradient-brand">Found</span>, Not Just
              Viewed.
            </h1>
            <p className="mt-6 max-w-xl text-base text-muted-foreground sm:text-lg">
              A complete LinkedIn makeover covering your headline, About
              section, skills, experience, and keyword strategy, designed to
              attract recruiter InMails and increase your profile visibility by
              up to 3x.
            </p>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-x-5 gap-y-2 text-xs text-muted-foreground">
              ...
              <div className="flex items-center gap-1.5">
                <ShieldCheck className="h-4 w-4 text-[color:var(--brand)]" /> Up
                to 3x Profile Visibility
              </div>
            </div>
          </div>
          ...
          <div className="reveal relative flex items-center justify-center">
            ...
            <img
              src="/linkdinprofile1.png" // your generated image
              alt="AI Generated LinkedIn Profile"
              className="relative z-10 w-full max-w-2xl rounded-3xl object-contain drop-shadow-2xl animate-float"
            />

            {/* Floating Badge */}
            <div className="absolute -right-4 bottom-10 z-20 hidden animate-float rounded-2xl glass px-4 py-2 text-xs font-medium shadow-lg [animation-delay:-5s] sm:block">
              <Search className="mr-1 inline h-3.5 w-3.5 text-[color:var(--brand)]" />
              3× More Recruiter Searches
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        <div className="reveal text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
            Every element of your profile that a recruiter sees, rewritten and
            optimised, not just a polish.
          </p>
        </div>
          ...
          <div className="relative grid gap-8 md:grid-cols-2 md:items-center">
            <div>
              ...
              <p className="mt-3 text-white/85">
                A full rewrite of your headline, About section, experience,
                skills, and banner, with a keyword strategy built for your
                target role and market.
              </p>
              <ul className="mt-5 space-y-2 text-sm text-white/80">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="h-4 w-4 flex-shrink-0" /> Delivery in
                  2–3 business days
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="h-4 w-4 flex-shrink-0" /> WhatsApp
                  support & revisions included
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="h-4 w-4 flex-shrink-0" /> 100%
                  satisfaction guarantee: we revise until you love it
                </li>
              </ul>
            </div>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-24">
        <div className="reveal rounded-2xl border border-border bg-white/60 p-8 text-center backdrop-blur">
          <p className="text-sm font-semibold text-[color:var(--brand)]">
            Not sure if you need LinkedIn, a resume, or both?
          </p>
          <p className="mx-auto mt-2 max-w-xl text-sm text-muted-foreground">
            Message us on WhatsApp, tell us your target role and market, and
            we'll recommend the right combination for you.
          </p>
