...
const faqs = [
  ...
  {
    q: "What are the Resume Customisation AI Prompts included in Standard & Premium?",
    a: "A curated set of tested AI prompts, included at no extra cost, that let you tailor your resume to any specific job description using Claude, ChatGPT, or Gemini — without losing the professional quality of your original Prolance document.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. We specialise in country-specific resume formats for the UK, USA, Canada, Australia, New Zealand, and GCC countries including UAE, Saudi Arabia, Qatar, Kuwait, and Bahrain — following each market's formatting conventions, keyword norms, and rules such as no-photo or no-date-of-birth where applicable.",
  },
  {
    q: "What does the 30 Days Editing Support cover?",
    a: "For 30 days after delivery, you can request free edits to your resume — update a job title, add a certification, tweak your skills for a different role, or restructure any section. Just message your assigned writer on WhatsApp.",
  },
  {
    q: "What if I am not happy with my resume?",
    a: "We offer unlimited revisions until you're completely satisfied, at no additional cost. Your assigned writer stays with you throughout the process.",
  },
];
